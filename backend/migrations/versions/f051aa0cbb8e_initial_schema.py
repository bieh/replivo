...
def upgrade():
    ...
    # document_chunks — vector column only if pgvector is available
    chunk_columns = [
        sa.Column('id', sa.String(length=36), nullable=False),
    ...
    if has_vector:
        ...
        chunk_columns.insert(-2, sa.Column('embedding', pgvector.sqlalchemy.vector.VECTOR(dim=1536), nullable=True))
